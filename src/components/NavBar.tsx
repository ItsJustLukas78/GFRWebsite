    ...
    <div className={`lg:hidden ${hamburgerOpen ? "block" : "hidden"} w-full pb-5 ml-5 sm:text-xl text-lg font-medium bg-[var(--primary-background-color)] text-white absolute top-24 left-0 right-0 z-10`}>
      <div className="flex flex-col gap-3 p-4">
        ...
        <div className="relative flex flex-col items-start">
          <button className="hover:text-[#DB4A4A]">Teams <IoIosArrowDown className="inline" onClick={() => setMobileTeamsExpanded(!mobileTeamsExpanded)} /></button>
        ...
        <Link href="/join" className="hover:text-[#DB4A4A]">Join Us</Link>
        <div className="relative group">
          <button className="hover:text-[#DB4A4A]">Timelines <IoIosArrowDown className="inline" onClick={() => setMobileTimelinesExpanded(!mobileTimelinesExpanded)} /></button>
