...
const footer = cva(["flex", "md:h-52", "h-[550px]", "w-full", "mx-auto", "max-w-screen-xl", "flex", "lg:gap-52", "gap-24", "flex-col", "md:flex-row", "mt-20", "xl:mx-auto", "mx-8", "px-7", "mb-14"], {
  variants: {
    intent: {
  ...
  return <div className={twMerge(footer({ intent, className }))}>
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-1">
        ...
        <h1 className="font-light">Code licensed under the <a href="/LICENSE.txt" className="text-[#DB4A4A]">MIT License</a></h1>
      </div>
